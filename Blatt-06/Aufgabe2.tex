...
\begin{frame}
  ...
  und die $\leq$-Ordnung eine totale Ordnung Bildet auf $\mathbb{R}$, kann für
  jede Komponente eines Ausgangs ein eindeutiger Vergleich zu jedem anderen
  Ausgang hergestellt werden.\\
  Widerspruchsbeweis: Angenommen: Es gibt ein Normalform spiel, in dem es
  ...
  nicht möglich, dass das Spiel endlich ist, da alle Aktionsmenge der Spieler
...
\begin{frame}
  ...
  also gleichzeitig auch ein Nach-Gleichgewicht.
\end{frame}
